...
Route::get('seller/showSeller/{seller}', [SellerController::class, 'getSeller']);
...
Route::middleware(['auth:sanctum'])->prefix('admin/coupon/')->group(function () {
    Route::get('', [CouponController::class , 'indexAll']);
...
Route::get('ads' , [AdminController::class, 'indexAdds']);
